...
<html lang="en" dir="ltr">
  <head>
    ...
    <link href="{{ url('assets') }}/plugins/data-tables/datatables.bootstrap4.min.css" rel='stylesheet'>
          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="/index.html" title="Sleek Dashboard">
                ...
                <span class="brand-name text-truncate">APS</span>
              </a>
            </div>
            ...
            <div class="" data-simplebar style="height: 100%;">
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                ...
                <li class="active">
                  <a class="sidenav-item-link" href="/tickets" >
                ...
                <li class="has-sub {{ $currentRoute == 'Customers' ? 'active' : '' }}">
                  ...
                  <ul class="collapse " id="components" data-parent="#sidebar-menu">
                    <div class="sub-menu">
                      <li class="">
                        <a class="sidenav-item-link" href="/customers">
                          <span class="nav-text">Customer list</span>
                        </a>
                      </li>

                      <li class="">
                        <a class="sidenav-item-link" href="/customers/create">
                ...
                <li class="has-sub ">
                  ...
                  <ul class="collapse " id="icons" data-parent="#sidebar-menu">
                    <div class="sub-menu">
                      <li class="">
                        <a class="sidenav-item-link" href="/billings">
                          <span class="nav-text">Billing list</span>
                        </a>
                      </li>

                      <li class="">
                        <a class="sidenav-item-link" href="/billings/create">
                          <span class="nav-text">Add Bill</span>
                        </a>
                      </li>
                    </div>
                  </ul>
                ...
                <li class="has-sub ">
                  <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#tables"
                    ...
                    <i class="Responsive-Data-Tablemdi mdi-table"></i>
                            ...
                            <ul class="list-unstyled" data-simplebar style="height: 360px">
                              <li>
                                <a href="javscript:void(0)" class="media media-message media-notification">
                                  <div class="position-relative mr-3">
                                    <img class="rounded-circle" src="{{ url('assets') }}/img/user/u2.jpg" alt="Image">
                              ...
                              <li>
                                <a href="javscript:void(0)" class="media media-message media-notification media-active">
                                  <div class="position-relative mr-3">
                                    <img class="rounded-circle" src="{{ url('assets') }}/img/user/u1.jpg" alt="Image">
                              ...
                              <li>
                                <a href="javscript:void(0)" class="media media-message media-notification">
                                  <div class="position-relative mr-3">
                                    <img class="rounded-circle" src="{{ url('assets') }}/img/user/u5.jpg" alt="Image">
                                    <span class="status away"></span>
                                  </div>
                                  <div class="media-body d-flex justify-content-between">
                                    <div class="message-contents">
                          ...
                          <div class="tab-pane fade" id="profile2" role="tabpanel" aria-labelledby="profile2-tab">
                            <ul class="list-unstyled" data-simplebar style="height: 360px">
                              <li>
                                <a href="javscript:void(0)" class="media media-message media-notification">
                                  <div class="position-relative mr-3">
                                    <img class="rounded-circle" src="{{ url('assets') }}/img/user/u6.jpg" alt="Image">
                                    <span class="status away"></span>
                                  </div>
                                  <div class="media-body d-flex justify-content-between">
                                    <div class="message-contents">
                              ...
                              <li>
                                <a href="javscript:void(0)" class="media media-message media-notification">
                                  <div class="position-relative mr-3">
                                    <img class="rounded-circle" src="{{ url('assets') }}/img/user/u7.jpg" alt="Image">
                                    <span class="status away"></span>
                                  </div>
                                  <div class="media-body d-flex justify-content-between">
                                    <div class="message-contents">
...
<!-- SUGA Content --> @yield('content')
    ...
    <footer class="footer mt-auto">
      <div class="copyright bg-white">
        <p>
          Copyright &copy; <span id="copy-year"></span> by <a class="text-primary" href="https://www.avvaiyarpadasalai.org" target="_blank">ஔவையார் பாடசாலை</a>.
        </p>
      </div>
      <script>
        var d = new Date();
